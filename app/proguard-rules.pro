...
# 保留pojo实体类
-keep class xyz.jdynb.dymovies.model.**{*;}

# 保留接口
# -keep class xyz.jdynb.dymovies.api.**

# viewbinding不进行混淆
-keep class xyz.jdynb.dymovies.databinding.**{*;}
...
-keep class xyz.jdynb.dymovies.config.**{*;}
-keep class xyz.jdynb.dymovies.event.**{*;}
